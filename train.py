...
for epoch in range(opt.epoch, opt.n_epochs):
    ...
    torch.save(netG_A2B.state_dict(), f'{opt.output_dir}/netG_A2B.pth')
    torch.save(netG_B2A.state_dict(), f'{opt.output_dir}/netG_B2A.pth')
    torch.save(netD_A.state_dict(), f'{opt.output_dir}/netD_A.pth')
    torch.save(netD_B.state_dict(), f'{opt.output_dir}/netD_B.pth')
###################################
